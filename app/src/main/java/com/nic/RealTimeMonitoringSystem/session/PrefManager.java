package com.nic.RealTimeMonitoringSystem.session;
...
public class PrefManager {
    ...
    public String getDeleteWork_type_link_id() {
        return pref.getString(DELETE_WORK_TYPE_LINK_ID,null);
    }

    public void setDeleteWork_type_link_id(String Work_type_link_id) {
        editor.putString(DELETE_WORK_TYPE_LINK_ID,Work_type_link_id);
        editor.commit();
    }
    public String getDeletegroup_work_type() {
        return pref.getString(DELETE_GROUP_WORK_TYPE,null);
    }

    public void setDeletegroup_work_type(String group_work_type) {
        editor.putString(DELETE_GROUP_WORK_TYPE,group_work_type);
        editor.commit();
    }
