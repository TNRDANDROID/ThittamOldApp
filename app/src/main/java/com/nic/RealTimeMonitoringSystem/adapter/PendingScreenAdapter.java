...
public class PendingScreenAdapter extends PagedListAdapter<RealTimeMonitoringSystem,PendingScreenAdapter.MyViewHolder> implements Filterable {
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
      ...
      holder.pendingScreenAdapterBinding.workId.setText(String.valueOf(pendingListFiltered.get(position).getWorkId()));
        ...
        final String group_work_type = pendingListFiltered.get(position).getGroup_work_type();
        final String work_type_link_id = pendingListFiltered.get(position).getWork_type_link_id();

        dbData.open();
        ArrayList<RealTimeMonitoringSystem> imageCount = dbData.selectImage(dcode,bcode,pvcode,work_id,type_of_work,cd_work_no,work_type_flag_le,work_type_link_id,group_work_type);
        ...
        holder.pendingScreenAdapterBinding.viewOfflineImages.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                viewOfflineImages(work_id,cd_work_no,work_type_flag_le,type_of_work,work_type_link_id,group_work_type,"Offline");
            }
        });
    ...
    public void viewOfflineImages(String work_id,String cd_work_no,String work_type_flag_le,String type_of_work,String work_type_link_id,String group_work_type,String OnOffType) {
        Activity activity = (Activity) context;
